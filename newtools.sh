...
clear
echo
echo $red" Tool akan di install dalam waktu 5 detik :v"
...
echo
echo $cy"==================="$pur" ==================="
echo $me"█"$bi"  Author  :  BrianZeDD           "$me"          █"
echo $ku"█"$bi"  WhatsApp:  085224890xxx"$ku"            █"
echo $bi"█"$bi"  Gmail   :  briyanmaulana21@gmail.com"$bi"    █"
echo $i"█"$bi"  Youtube :  Briyan7260"$i"             █"
echo $me"==================="$ku" ==================="
echo
echo $i"-----› PILIH SESUAI KEINGINAN ANDA :v"
...
echo $cy"⟨"$pu"14"$cy"⟩"$bi"-» Cloning Yahoo.co.id"
echo $cy"⟨"$pu"15"$cy"⟩"$bi"-» Keluar"
echo
echo $pu"╭─["$i"Pilih sesuai ke inginan Lo :v"$pu"]"
read -p"╰─> : " pil
...
figlet -f slant "Lest G O ."|lolcat
sleep 1
git clone https://github.com/brianm26/BrianZeDD
cd BrianZeDD
python2 briyanyahoo.py
fi
...
echo $i"Melalui Via:"
sleep 2
echo $ku"Facebook :"$pur" Briyan Maulana"
echo $ku"YouTube  :"$pur" Briyan7260"
echo $ku"WhatsApp :"$pur" 085224890xxx"
sleep 2
echo $i"dan jangan lupa "$cy" LIKE SHARE AND SUBSCRIBE"
sleep 2
echo $i"Video Channel "$cy" Briyan7260"
sleep 2
